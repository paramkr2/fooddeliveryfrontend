...
export default function Checkbox({ children, id, isChecked, setIsChecked }: CheckboxProps) {
  return (
    <div className="flex items-center">
      <CheckboxIndicator id={id} isChecked={isChecked} setIsChecked={setIsChecked} />
      <CheckboxLabel id={id} isChecked={isChecked}>{children}</CheckboxLabel>
    </div>
  );
}
...
function CheckboxIndicator({ id, isChecked, setIsChecked }: CheckboxIndicatorProps) {
  return (
...
function CheckboxLabel({ children, id, isChecked }: CheckboxLabelProps) {
  return (
    <motion.label
